    ...
    <body>
        <header id="header">
            <nav id="navbar" class="navbar navbar-expand-lg">
                <div class="container">
                    <a class="navbar-brand" href="https://www.inikarir.com/lapangan-kerja">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="container d-lg-flex px-0">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link" href="https://www.inikarir.com/lapangan-kerja">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">About</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="https://www.inikarir.com/lapangan-kerja/layanan-kami.php">Services</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="https://www.inikarir.com/lapangan-kerja/blog.php">Article</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="col-12 col-sm-12 col-md-4 pt-4 md-pt-0">
                         ...
                         <script 
                            ...
                            async data-usrc>
                                ...
                                <!--        <img src="../assets/images/DSC03092 1.png" class="w-100 h-100 position-absolute top-0 end-0 start-0 bottom-0" alt="Image">-->
                                <!--    </div>-->
                                <!--</div> <!-- /.ads -->
                            </div>
                        </div> <!-- /.col -->
