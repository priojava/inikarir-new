                                    ...
                                    <div class="relative hero-blog-slider__content">
                                        <div class="position-absolute top-0 start-0 bottom-0 end-0 d-flex align-items-end">
                                            <div class="hero-blog-slider__content-title fw-bold fs-3 relative text-white p-3 p-md-5">
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in commodo felis.
                                            </div>
                                        </div>

                                        <img src="./assets/images/INKA4_11zon_11zon.webp" class="position-absolute rounded top-0 start-0 bottom-0 end-0 w-100 h-100" alt="Image">
                                    </div>
                                </div>
                            </div> <!-- /.item -->
                            ...
                            <div class="swiper-slide">
                                <div class="hero-article__item">
                                    <div class="hero-article__item-image ratio ratio-4x3 position-relative">
                                        <div>
                                            <img src="./assets/images/DSC03092 1.webp" class="w-100 h-100 position-absolute start-0 top-0 bottom-0 end-0" alt="Image">
                                            ...
                                            <div class="row d-flex align-items-lg-center">
                                                ...
                                                <div class="col-7">
                                                    <div class="hero-top-pick__content">
                                                        ...
                                                        <div class="fw-bold fs-5 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
                                                        <div class="text-xs text-muted fst-italic">by IniKarir</div>
                                                        <div class="mt-3 text-sm">Morbi eget tincidunt lorem. Nullam pellentesque, sem at consequat congue, lacus leo efficitur orci</div>
                                                    </div> <!-- /.content -->
                                                </div> <!-- /.col -->
                                            </div> <!-- /.row -->
                                        </div> <!-- /.item -->
                            ...
                            <div class="ps-md-3 ps-lg-4 d-flex flex-column h-100">
                                <div class="block flex-none">
                                    ...
                                    <ul class="hero-top-pick__video-list list-unstyled d-flex flex-column w-100">
                                        <li>
                                            <div class="hero-top-pick__video-item position-relative">
                                                <div class="ratio ratio-16x9 mb-3">
                                                    <div>
                                                        <img src="./assets/images/DSC03092 1.webp" class="rounded w-100 h-100 position-absolute start-0 top-0 bottom-0 end-0" alt="Image">
                                                        <div class="hero-top-pick__video-timer px-2 py-1 text-xs position-absolute rounded text-white d-flex align-items-center">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z"/>
                                                                </svg>
                                                            </span>
                                                            <span class="ps-2">10:14</span>
                                                        </div>
                                                    </div>
                                                </div>
